...
from django.core.validators import MinLengthValidator, int_list_validator,MinValueValidator, MaxValueValidator
...
class Student(models.Model):
    ...
    matricula = models.CharField(max_length=9, validators=[MinLengthValidator(9), int_list_validator(allow_negative=False)])
    student_id = models.AutoField(auto_created=True, primary_key=True, default=1,  editable=False)
